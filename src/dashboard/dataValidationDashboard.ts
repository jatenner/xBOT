...
<body>
    <div class="container">
        ...
        <div class="nav-tabs">
            ...
            <a href="/dashboard/data-validation?token=xbot-admin-2025" class="nav-tab active">🔬 Data Validation</a>
...
<body>
    <div class="error-box">
        ...
        <p><a href="/dashboard/data-validation?token=xbot-admin-2025">🔄 Try Again</a></p>
    </div>
</body>
</html>`;
}
