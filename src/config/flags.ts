...
// Thread segmentation controls
export const THREAD_FORCE_SEGMENTS = process.env.THREAD_FORCE_SEGMENTS === 'true';
export const THREAD_SEGMENT_DELIMITER = process.env.THREAD_SEGMENT_DELIMITER ?? '---';
export const THREAD_NUMBERING_REGEX = process.env.THREAD_NUMBERING_REGEX ?? '^\\s*\\d+/\\d+\\b';
