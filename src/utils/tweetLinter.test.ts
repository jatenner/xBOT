...
import { lintAndSplitThread, LintResult } from './tweetLinter';
  ...
  describe('lintAndSplitThread', () => {
    ...
    describe('validation rules', () => {
      ...
      it('validates thread T1 against 240 char limit', () => {
        const veryLongT1 = 'A'.repeat(300); // Too long to trim properly
      ...
      it('validates thread T2+ against 270 char limit', () => {
        ...
        const veryLongT2 = 'A'.repeat(350); // Too long to trim properly
    ...
    describe('logging output', () => {
      it('logs actions correctly', () => {
        ...
        const complexTweet = 'A'.repeat(300) + ' #health tip 😊🌟';
