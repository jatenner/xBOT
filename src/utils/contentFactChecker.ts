...
ASSESSMENT:`;
  ...
  private combineResults(
    ...
    const shouldPost = aiCheck.isValid && combinedConfidence > 0.1; // Lower threshold for health content
    ...
    const strictThreshold = request.strictMode ? 0.25 : 0.15; // More lenient thresholds
