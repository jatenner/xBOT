-- 🧠 INTELLIGENT LEARNING ENHANCEMENT - WORKING VERSION
-- ======================================================
-- Adds intelligent learning capabilities to your existing Twitter bot database
-- This version ensures all SQL works correctly with proper constraints and defaults
...
CREATE TABLE IF NOT EXISTS semantic_content_analysis (
  ...
  -- Semantic Analysis (with proper defaults)
  ...
  -- Content Structure Analysis (with proper defaults)
  ...
  -- Learning Insights (with proper defaults)
...
CREATE TABLE IF NOT EXISTS content_patterns (
  ...
  -- Pattern Definition (with proper defaults)
...
CREATE TABLE IF NOT EXISTS autonomous_improvements (
  ...
  -- Problem Analysis (with proper defaults)
  ...
  -- Solution Design (with proper defaults)
...
-- =====================================================
-- 6. TWEET METRICS ENHANCEMENT (for better tracking)
-- =====================================================
...
CREATE INDEX IF NOT EXISTS idx_tweet_metrics_engagement_rate ON tweet_metrics(engagement_rate);
CREATE INDEX IF NOT EXISTS idx_tweet_metrics_captured_at ON tweet_metrics(captured_at);

-- =====================================================
-- INTELLIGENT LEARNING FUNCTIONS (WORKING VERSIONS)
-- =====================================================

-- Function to analyze content semantically
...
-- Function to capture tweet metrics
...
-- Insert initial successful patterns with proper defaults
INSERT INTO content_patterns (
  pattern_type, 
  pattern_name, 
  pattern_signature, 
...
-- Add initial bot config for learning
...
-- Log the enhancement completion
INSERT INTO system_logs (action, data, source) VALUES
('intelligent_learning_enhancement_complete', jsonb_build_object(
  'tables_created', 6,
  'functions_created', 4,
  'seed_data_inserted', true,
  'enhancement_date', NOW()::text
), 'enhancement_script');
