-- Fix tweet_metrics and learning_posts schema with all required columns
-- Based on error logs showing missing: likes_count, retweets_count, replies_count, bookmarks_count, impressions_count

-- Create tweet_metrics table with all required columns (idempotent)
...
-- Create learning_posts table with all required columns (idempotent)
