-- INTELLIGENT POSTING SYSTEM TABLES (FIXED)
...
INSERT INTO trending_topics (topic, momentum, health_relevance, viral_potential, opportunity_score) VALUES
...
SELECT 'Fixed intelligent posting system tables created successfully!' AS result;