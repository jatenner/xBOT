#!/bin/bash
# Verify Railway deployment from GitHub
...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "           🔍 VERIFYING GITHUB DEPLOYMENT"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
echo "Expected SHA: $EXPECTED_SHORT (or newer)"
...
while [ $ATTEMPT -lt $MAX_ATTEMPTS ]; do
  ...
  if [ $? -eq 0 ]; then
    ...
    if [ "$SHA_MATCH" = true ] && [ "$BOOT_CHANGED" = true ]; then
      echo ""
      echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
      echo "           ✅ GITHUB DEPLOYMENT VERIFIED"
      echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
      echo ""
      echo "✅ Commit $EXPECTED_SHORT (or newer) is now live!"
