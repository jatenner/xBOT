...
const costAuditDashboard_1 = require("../src/analytics/costAuditDashboard");
const openaiCostTracker_1 = require("../src/analytics/openaiCostTracker");
async function runCostAudit() {
    ...
    try {
        ...
        const textReport = await costAuditDashboard_1.costAuditDashboard.generateTextReport();
        console.log(textReport);
        // 2. Check for emergency stop condition
        console.log('\n🚨 CHECKING EMERGENCY CONDITIONS...');
        const isEmergencyStop = await openaiCostTracker_1.openaiCostTracker.isEmergencyStop();
        if (isEmergencyStop) {
        ...
        const summary = await openaiCostTracker_1.openaiCostTracker.getCostSummary();
        console.log('\n🤖 TOP COST OPERATIONS:');
        ...
        const target = await openaiCostTracker_1.openaiCostTracker.getDailyCostTarget();
        ...
        const auditReport = await costAuditDashboard_1.costAuditDashboard.generateAuditReport();
...
//# sourceMappingURL=cost-audit.js.map