...
function testQualityGates() {
    ...
    const results = testCases.map(testCase => {
        ...
        const hasBannedPhrase = bannedPhrases.some(phrase => testCase.content.toLowerCase().includes(phrase.toLowerCase()));
        const firstPersonWords = [' i ', ' me ', ' my ', 'personally'];
        const hasFirstPerson = firstPersonWords.some(word => testCase.content.toLowerCase().includes(word));
...
function testMegaPromptSignature() {
...
//# sourceMappingURL=simple-verification.js.map