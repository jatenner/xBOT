...
exports.fixContentGeneration = fixContentGeneration;
const dotenv_1 = require("dotenv");
(0, dotenv_1.config)();
const authoritativeContentEngine_1 = require("../src/ai/content/authoritativeContentEngine");
...
async function fixContentGeneration() {
    ...
    try {
        const contentEngine = authoritativeContentEngine_1.AuthoritativeContentEngine.getInstance();
...
//# sourceMappingURL=fix-content-generation.js.map