...
- ✅ **service_role:** `serene-cat` (Railway worker)
...
- ✅ **Used at:** `2026-01-10T18:23:06.508+00:00`
...
- ✅ Implemented in `getReadyDecisions()` (converted filter to async for loop)

### Auto-heal
- ✅ If decision queued >10 min AND permit APPROVED → clear deferral + force re-enqueue
- ✅ Implemented in `healDeferrals()` function
...
- `src/jobs/postingQueue.ts` - Integration (lines 1091-1110, 2495-2565)
...
- Posting queue integration: `src/jobs/postingQueue.ts:1091-1110, 2495-2565`
- Success event logging: `src/jobs/postingQueue.ts:4797-4855`
- Permit reuse: `src/posting/postingPermit.ts:36-89`

## Status

✅ **GOLD PROOF PASS** - End-to-end reply posting verified with full trace chain and deferral hardening implemented.
