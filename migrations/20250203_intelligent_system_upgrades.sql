...
VALUES ('20250203_intelligent_system_upgrades.sql', NOW())
ON CONFLICT (filename) DO NOTHING;

-- Success message
DO $$ 
BEGIN
  RAISE NOTICE '✅ Intelligent System Upgrades migration completed successfully';
  RAISE NOTICE '📊 Created tables: follower_snapshots, follower_deltas, bandit_states, bandit_selections';
  RAISE NOTICE '🎨 Created CTA optimization system with 8 default templates';
  RAISE NOTICE '📰 Added trending topics cache and system alerts';
