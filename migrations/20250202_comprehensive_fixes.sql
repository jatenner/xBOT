...
-- Date: 2025-02-02
-- Purpose: Fix all type mismatches and constraint issues causing failures
...
-- 5. Create index for efficient duplicate checking (regular index without predicate)
...
DELETE FROM tweets WHERE tweet_id LIKE 'test_composer_reset_%';
DELETE FROM learning_posts WHERE content = 'Test content';
DELETE FROM post_history WHERE original_content = 'Test content';