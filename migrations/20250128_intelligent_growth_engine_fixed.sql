/**
 * 🧠 INTELLIGENT GROWTH ENGINE DATABASE SCHEMA (FIXED)
...
CREATE INDEX IF NOT EXISTS idx_posting_time_performance ON posting_time_analytics(performance_score DESC);
CREATE INDEX IF NOT EXISTS idx_posting_time_hour ON posting_time_analytics(hour_slot);
...
CREATE INDEX IF NOT EXISTS idx_topic_priority ON topic_performance_analytics(priority_weight DESC);
CREATE INDEX IF NOT EXISTS idx_topic_viral_score ON topic_performance_analytics(viral_potential_score DESC);
...
CREATE INDEX IF NOT EXISTS idx_influencer_priority ON influencer_engagement_log(priority_tier, engagement_value DESC);
CREATE INDEX IF NOT EXISTS idx_influencer_response_rate ON influencer_engagement_log(response_rate DESC);
...
CREATE INDEX IF NOT EXISTS idx_viral_opportunities ON viral_reply_opportunities(viral_score DESC, attempted_reply);
CREATE INDEX IF NOT EXISTS idx_reply_timing ON viral_reply_opportunities(optimal_reply_timing);
...
CREATE INDEX IF NOT EXISTS idx_format_effectiveness ON content_format_analytics(format_effectiveness DESC);
CREATE INDEX IF NOT EXISTS idx_format_viral_rate ON content_format_analytics(viral_hit_rate DESC);
...
CREATE INDEX IF NOT EXISTS idx_strategy_date ON daily_growth_strategy(strategy_date DESC);
CREATE INDEX IF NOT EXISTS idx_strategy_effectiveness ON daily_growth_strategy(strategy_effectiveness DESC);
...
CREATE INDEX IF NOT EXISTS idx_hourly_metrics_time ON hourly_performance_metrics(recorded_hour DESC);
CREATE INDEX IF NOT EXISTS idx_growth_velocity ON hourly_performance_metrics(growth_velocity DESC);
...
CREATE INDEX IF NOT EXISTS idx_learning_insights_priority ON ai_learning_insights(implementation_priority, confidence_score DESC);
CREATE INDEX IF NOT EXISTS idx_learning_insights_category ON ai_learning_insights(insight_category, discovered_at DESC);
...
-- Success message
SELECT 'Intelligent Growth Engine database schema created successfully!' as message; 